# same as 2_prg but change in apply raise()
...
# instead of changing emp1 raise ammount to 1.05 it calculate it on basis of
# 1.05 because in raise_pay() there is  Employee.raise amount
# self.pay = int(self.pay * Employee.raise_amount)
# to change raise_amount for emp1 there should be self.raise_amount
